...
sudo sh -c "echo CVMFS_CACHE_EXTERNAL_LOCATOR=unix=/var/lib/cvmfs/cvmfs-cache.socket >> /etc/cvmfs/default.d/90-ramcache.conf"
sudo sh -c "echo CVMFS_CACHE_EXTERNAL_SIZE=1500 >> /etc/cvmfs/default.d/90-ramcache.conf"
