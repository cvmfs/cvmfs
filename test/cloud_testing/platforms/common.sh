...
run_unittests() {
  ...
  cat > $UNITTEST_LOGFILE << EOF
<?xml version="1.0" encoding="UTF-8"?>
<testsuites tests="1.0" failures="1.0" disabled="1.0" errors="0" timestamp="1.0" time="1.0" name="CVMFS Test Runner">
  <testsuite hostname="$CVMFS_PLATFORM_NAME" name="$CVMFS_TEST_SUITE_NAME" timestamp="$CVMFS_TIMESTAMP" tests="1.0" failures="1.0" disabled="1.0" errors="0" time="1.0">
EOF
