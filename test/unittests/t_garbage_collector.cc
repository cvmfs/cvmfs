...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  ...
  EXPECT_EQ (10u, upl->deleted_hashes.size());
  EXPECT_EQ (11u, gc2.preserved_catalog_count());
  EXPECT_EQ ( 5u, gc2.condemned_catalog_count());
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  ...
  EXPECT_EQ (8u, gc3.preserved_catalog_count());
  EXPECT_EQ (8u, gc3.condemned_catalog_count());
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  ...
  EXPECT_EQ (8u, gc4.preserved_catalog_count());
