...
TYPED_TEST(T_HashFilter, EmptyFilter) {
  ...
  EXPECT_FALSE(
    filter.Contains(md5("eb8a956c0a1164b84262505a629e8a1f")));

  EXPECT_FALSE(filter.Contains(sha("ed0e0b2c3590bb9e72f849ed6bebb97f06371abf",
               shash::kSuffixCatalog)));
  EXPECT_FALSE(filter.Contains(rmd("f66853b7a7731719f3babb59623b00b3e02a4a4f",
               shash::kSuffixHistory)));
  EXPECT_FALSE(filter.Contains(md5("c70ac2b76b5c25b07ae80ea572bb8265",
               shash::kSuffixCatalog)));
}
