...
TEST(T_Shash, IsNull) {
  ...
  EXPECT_EQ   ("0000000000000000000000000000000000000000-rmd160", hash_rmd160.ToString());
}
...
TEST(T_Shash, MakePathDefault) {
  ...
  EXPECT_EQ ("dataX/95/9a032bcfdd999742a321eb0daeddd5", hash_md5.MakePath("dataX"));
  EXPECT_EQ ("dataY/95/9a032bcfdd999742a321eb0daeddd5", hash_md5.MakePath("dataY"));
  EXPECT_EQ ("dataZ/95/9a032bcfdd999742a321eb0daeddd5", hash_md5.MakePath("dataZ"));

  shash::Any hash_sha1(shash::kSha1);
  hash_sha1.Randomize(prng);
  ASSERT_FALSE (hash_sha1.IsNull());
  EXPECT_EQ ("data/cf/3e56cf3da37ad17cf1f2c2ff5d86497fc29068",  hash_sha1.MakePath());
  EXPECT_EQ ("dataX/cf/3e56cf3da37ad17cf1f2c2ff5d86497fc29068", hash_sha1.MakePath("dataX"));
  EXPECT_EQ ("dataY/cf/3e56cf3da37ad17cf1f2c2ff5d86497fc29068", hash_sha1.MakePath("dataY"));
  EXPECT_EQ ("dataZ/cf/3e56cf3da37ad17cf1f2c2ff5d86497fc29068", hash_sha1.MakePath("dataZ"));

  shash::Any hash_rmd160(shash::kRmd160);
  hash_rmd160.Randomize(prng);
  ASSERT_FALSE (hash_rmd160.IsNull());
  EXPECT_EQ ("data/aa/1deda59d5329553580d78fcd0b393157a5d28e-rmd160",  hash_rmd160.MakePath());
  EXPECT_EQ ("dataX/aa/1deda59d5329553580d78fcd0b393157a5d28e-rmd160", hash_rmd160.MakePath("dataX"));
  EXPECT_EQ ("dataY/aa/1deda59d5329553580d78fcd0b393157a5d28e-rmd160", hash_rmd160.MakePath("dataY"));
  EXPECT_EQ ("dataZ/aa/1deda59d5329553580d78fcd0b393157a5d28e-rmd160", hash_rmd160.MakePath("dataZ"));
}
...
TEST(T_Shash, LowerThan) {
  EXPECT_LT (md5("00000000000000000000000000000000"), md5("3a5ebf256415b7f4cce58505026c95f9"));
  EXPECT_LT (md5("1de4351771a2485cf9f529c696404eaa"), md5("3a5ebf256415b7f4cce58505026c95f9"));
  EXPECT_LT (md5("3a5ebf256415b7f4cce58505026c95f9"), md5("ae1332b41f2ec2e455eae5908fa8eca1"));
  ...
  EXPECT_LT (sha1("3cc2a7bc3db3ce79ebcb75ca3f01680ec74e9fbd"), sha1("813cdb0163dcff260f1a0ca2647184a2877f1c7f"));
  EXPECT_LT (sha1("813cdb0163dcff260f1a0ca2647184a2877f1c7f"), sha1("da39a3ee5e6b4b0d3255bfef95601890afd80709"));
  ...
  EXPECT_LT (rmd160("7e1363cebb1e1f4584111343da5a2d84858a2349"), rmd160("a7fcc792608978d3e6e01352e45a3a66e1488fcc"));
  EXPECT_LT (rmd160("a7fcc792608978d3e6e01352e45a3a66e1488fcc"), rmd160("d61c9a94f632a51b5920a91f5ad6ff6f0b36e968"));
...
TEST(T_Shash, GreaterThan) {
  EXPECT_GT (md5("3a5ebf256415b7f4cce58505026c95f9"), md5("00000000000000000000000000000000"));
  EXPECT_GT (md5("3a5ebf256415b7f4cce58505026c95f9"), md5("1de4351771a2485cf9f529c696404eaa"));
  EXPECT_GT (md5("ae1332b41f2ec2e455eae5908fa8eca1"), md5("3a5ebf256415b7f4cce58505026c95f9"));
  ...
  EXPECT_GT (sha1("813cdb0163dcff260f1a0ca2647184a2877f1c7f"), sha1("3cc2a7bc3db3ce79ebcb75ca3f01680ec74e9fbd"));
  EXPECT_GT (sha1("da39a3ee5e6b4b0d3255bfef95601890afd80709"), sha1("813cdb0163dcff260f1a0ca2647184a2877f1c7f"));
  ...
  EXPECT_GT (rmd160("a7fcc792608978d3e6e01352e45a3a66e1488fcc"), rmd160("7e1363cebb1e1f4584111343da5a2d84858a2349"));
  EXPECT_GT (rmd160("d61c9a94f632a51b5920a91f5ad6ff6f0b36e968"), rmd160("a7fcc792608978d3e6e01352e45a3a66e1488fcc"));
