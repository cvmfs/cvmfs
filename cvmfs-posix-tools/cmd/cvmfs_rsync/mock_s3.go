...
func (s3Manager *MockS3Manager) uploadGivenInfo(reader io.ReadSeeker, partSize int64, retries int, s3Dest string, fileToUpload *pkg.UploadFile, overwriteExisting bool, headObjectCheck bool) error {
	return nil
}
...
func (S3Manager *MockS3Manager) uploadReaderList(fileName string, readers []pkg.NamedReader, partSize int64, maxConcurrentUploaders int, overwriteExisting bool, headObjectCheck bool, fileToUpload *pkg.UploadFile, compressor *pkg.Compressor) error {
	return nil
}
