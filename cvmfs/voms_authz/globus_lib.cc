 ...
 *
 * This contains stubs and loaders for the various Globus libraries;
 * it allows us to load and use the libraries at runtime but not
...
{
  Load();
  LogCvmfs(kLogVoms, kLogDebug|kLogSyslog, "Support for Globus authz is "
                                           "%senabled.",
                                            m_zombie ? "NOT " : "");
}
