 ...
 *
 * This defines the various symbols we will use from Globus.
 */

#ifndef CVMFS_VOMS_AUTHZ_GLOBUS_LIB_H_
#define CVMFS_VOMS_AUTHZ_GLOBUS_LIB_H_
...
#endif  // CVMFS_VOMS_AUTHZ_GLOBUS_LIB_H_
