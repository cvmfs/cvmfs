 ...
 * class which is a sub-class of the Compressor. The subclass needs to implement the
 * Decompress, DecompressUpperBound, Clone, and WillHandle functions.  For information on
