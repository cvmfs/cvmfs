...
_CVMFS_DOC_MKFS_SHORT="Creates a new repository with a given name"
_CVMFS_DOC_MKFS_SYNOPSIS="[options] <fqrn>"
_CVMFS_DOC_MKFS_DESCRIPTION="TODO"
_CVMFS_DOC_MKFS_OPTIONS="\
