...
void SyncItem::CheckPath() {
  is_path_present_ = PathExists(GetUnionPath() + "/.cvmfscatalog");
}

void SyncItem::CheckRegular() {
  is_regular_ = RegularExists(GetUnionPath() + "/.cvmfscatalog");
}
