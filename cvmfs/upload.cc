...
void Spooler::FinalizeSession(bool commit, const std::string &old_catalog,
                              const std::string &new_catalog) const {
  uploader_->FinalizeSession(commit, old_catalog, new_catalog);
}
