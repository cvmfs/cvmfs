 ...
 */
#ifndef CVMFS_EXPORT_PLUGIN_POSIX_GARBAGE_COLLECTOR_H_
#define CVMFS_EXPORT_PLUGIN_POSIX_GARBAGE_COLLECTOR_H_
...
#endif  // CVMFS_EXPORT_PLUGIN_POSIX_GARBAGE_COLLECTOR_H_
