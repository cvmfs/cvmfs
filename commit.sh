...
sed -i s/2\.0\.[0-9]*/2.0.$[$1+1]/ packaging/rpm/cvmfs.spec
sed -i s/2\.0\.[0-9]*/2.0.$[$1+1]/ packaging/rpm/cvmfs-server.spec
sed -i s/2\.0\.[0-9]*/2.0.$[$1+1]/ packaging/rpm/cvmfsflt.spec
