...
option (BUILD_CVMFS_SHRINKWRAP  "Build the shrinkwrap tool"                                        OFF)
option (BUILD_CVMFS_EXPORT      "Build the export tool"                                            ON)
...
if (BUILD_ALL)
  ...
  if (!MACOSX)
    ...
    set (BUILD_CVMFS_SHRINKWRAP ON)
    set (BUILD_CVMFS_EXPORT ON)
