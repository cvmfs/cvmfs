...
func GetGCStateHandler(services be.ActionController) httprouter.Handle {
...
func RunGCHandler(services be.ActionController) httprouter.Handle {
	return func(w http.ResponseWriter, h *http.Request, ps httprouter.Params) {
		// ctx := h.Context()
...
func StopGCHandler(services be.ActionController) httprouter.Handle {
	return func(w http.ResponseWriter, h *http.Request, ps httprouter.Params) {
		// ctx := h.Context()
